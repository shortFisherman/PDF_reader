...
早期识别的基础可靠性候选（不可变文档身份、服务端任务互斥与生命周期、SSE 断开和后台任务所有权、依赖锁可移植安装、术语表与 PDF 替换事务）已分别作为 [工程与架构长期改进清单](engineering-improvement-plan-829.md) 的 P0-01/P0-02/P0-03 与 P1-01/P1-02/P1-03 实施并验收，不再保留为路线图候选。剩余的工程卫生与生命周期候选见同一清单的 P3 部分；本文件继续保存产品方向与体验类候选。
